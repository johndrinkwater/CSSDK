...
// Monsters
	...
	// CSSDK
	BOOL IsCareer( void ) { return g_engfuncs.pfnIsCareerMatch(); };
	...
	int				m_iIntroRoundTime;			//  68/60  -
	float			m_flIntroRoundCount;		//  72/64  -

	int				m_iAccountTerrorist;		//  76/68  -
	int				m_iAccountCT;				//  80/72  -

	int				m_iNumTerrorist;			//  84/76  -
	int				m_iNumCT;					//  88/80  -
	int				m_iNumSpawnableTerrorist;	//  92/84  -
	int				m_iNumSpawnableCT;			//  96/88  -
	int				m_iNumTerroristSpawnPoint;	// 100/92  -
	int				m_iNumCTSpawnPoint;			// 104/96  -

	int				m_iHostagesRescued;			// 108/100 - 
	int				m_iHostagesTouched;			// 112/104 - 

	int				m_iRoundWinStatus;			// 116/108 - 0: CTs win, 1: Terrorists win, 3: Round draw/Game commencing.
	unsigned short	m_iNumCTWins;				// 120/112 - 
	unsigned short	m_iNumTerroristWins;		// 122/114 - 

	bool			m_bTargetBombed;			// 124/116 -
	bool			m_bBombDefused;				// 125/117 -
	bool			m_bMapHasBombTarget;		// 126/118 - 
	bool			m_bMapHasBombZone;			// 127/119 -
	bool			m_bMapHasBuyZone;			// 128/120 -
	bool			m_bMapHasRescueZone;		// 129/121 -
	bool			m_bMapHasEscapeZone;		// 130/122 -
	int				m_iMapHasVIPSafetyZone;		// 131/123 -
