...
{
	// ID			  COST			 TEAM					     SLOT			ACOST     
	WEAPON_P228		, 600	, TEAM_TERRORIST | TEAM_CT	, ITEMSLOT_SECONDARY	, 50,
	WEAPON_SCOUT	, 2750	, TEAM_TERRORIST | TEAM_CT	, ITEMSLOT_PRIMARY		, 80,
	WEAPON_XM1014	, 3000	, TEAM_TERRORIST | TEAM_CT	, ITEMSLOT_PRIMARY		, 65,
	WEAPON_MAC10	, 1400	, TEAM_TERRORIST			, ITEMSLOT_PRIMARY		, 25,
	WEAPON_AUG		, 3500	, TEAM_CT					, ITEMSLOT_PRIMARY		, 60,
	WEAPON_ELITE	, 800	, TEAM_TERRORIST			, ITEMSLOT_SECONDARY	, 20,
	WEAPON_FIVESEVEN, 750	, TEAM_TERRORIST | TEAM_CT	, ITEMSLOT_SECONDARY	, 50,
	WEAPON_UMP45	, 1700	, TEAM_CT					, ITEMSLOT_PRIMARY		, 25,
	WEAPON_SG550	, 4200	, TEAM_CT					, ITEMSLOT_PRIMARY		, 60,
	WEAPON_GALIL	, 2000	, TEAM_TERRORIST			, ITEMSLOT_PRIMARY		, 60,
	WEAPON_FAMAS	, 2250	, TEAM_CT					, ITEMSLOT_PRIMARY		, 60,
	WEAPON_USP		, 500	, TEAM_TERRORIST | TEAM_CT	, ITEMSLOT_SECONDARY	, 25,
	WEAPON_GLOCK18	, 400	, TEAM_TERRORIST | TEAM_CT	, ITEMSLOT_SECONDARY	, 20,
	WEAPON_AWP		, 4750	, TEAM_TERRORIST | TEAM_CT	, ITEMSLOT_PRIMARY		, 125,
	WEAPON_MP5NAVY	, 1500	, TEAM_TERRORIST | TEAM_CT	, ITEMSLOT_PRIMARY		, 20,
	WEAPON_M249		, 5750	, TEAM_TERRORIST | TEAM_CT	, ITEMSLOT_PRIMARY		, 60,
	WEAPON_G3SG1	, 5000	, TEAM_CT					, ITEMSLOT_PRIMARY		, 80,
	WEAPON_DEAGLE	, 650	, TEAM_TERRORIST | TEAM_CT	, ITEMSLOT_SECONDARY	, 40,
	WEAPON_SG552	, 3500	, TEAM_TERRORIST			, ITEMSLOT_PRIMARY		, 60,
	WEAPON_AK47		, 2500	, TEAM_TERRORIST			, ITEMSLOT_PRIMARY		, 80,
	WEAPON_P90		, 2350	, TEAM_TERRORIST | TEAM_CT	, ITEMSLOT_PRIMARY		, 50,
	WEAPON_SHIELD	, 2200	, TEAM_CT					, 0						, 0
};
...
void CBasePlayerWeapon::KickBack( float up_base, float lateral_base, float up_modifier, float lateral_modifier, float up_max, float lateral_max, int direction_change )
{
	...
	Vector angles = m_pPlayer->pev->punchangle;
	angles.x -= flKickUp;

	if( angles.x < -1 * up_max )
		angles.x = -1 * up_max;
	         
	if( m_iDirection == 1 )
	{
		angles.y += flKickLateral;

			if( angles.y > lateral_max )
	...
	else
	{
		...
		if ( angles.y < -1 * lateral_max )
			angles.y = -1 * lateral_max;
	}
